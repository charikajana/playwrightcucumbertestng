@Sanity @Sabre_vs_Sabre_Sanity @MultiRoom_MultiGuest
Feature: Sabre vs Sabre Single Night Multi Room Multi Guest Booking
#MultiRoom_MultiGuest when User Selects Multiple Rooms and Multiple Guests drop down getting disabled so we set the GuestCount as 1 only
  Background:
  ...
  Scenario Outline: Sabre vs Sabre Single Night Multi Room Multi Guest Standard Booking
    # SHOP Phase
    ...
    Examples:
      ...
      | USA     | Dallas   | 20 Miles | 30   | 1      | 2     | 1      | Sabre    | Yes         | Credit Card    |
