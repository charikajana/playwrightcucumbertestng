...
Feature: Sabre vs Sabre Multi Night Single Room Single Guest Booking
  ...
  Scenario Outline: Sabre vs Sabre Shop With Exact Hotel Name Booking Flow
    # SHOP Phase
    ...
    Examples:
      ...
      | USA     | Dallas   | W Hotel Dallas Victory | 20 Miles | 90   | 1      | 1     | 1      | Sabre    | Yes         | Credit Card    | Cancel by Room | Booker,Agent,Client |
