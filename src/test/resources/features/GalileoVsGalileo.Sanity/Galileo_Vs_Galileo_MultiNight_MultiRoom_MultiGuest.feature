@Galileo_vs_Galileo_Sanity @Sanity @Vadana
Feature: Sabre vs Sabre Multi Night Single Room Single Guest Booking
  ...
  Scenario Outline: Sabre vs Sabre Multi Night Single Room Single Guest Standard Booking
    ...
    Examples:
      ...
      | USA     | Dallas   | Holiday   | 20 Miles | 90   | 3      | 2     | 2      | Sabre    | Yes         | Credit Card    | Cancel by Room | Booker,Agent,Client |
