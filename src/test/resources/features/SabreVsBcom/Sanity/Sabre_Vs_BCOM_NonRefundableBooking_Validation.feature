@Sabre_vs_BCOM_Sanity @Sanity @Test @Vadana
Feature: Sabre vs Sabre Sabre vs Sabre NonRefundable Booking Flow Validation
  ...
  Scenario Outline: Sabre vs Sabre Multi Night Single Room Single Guest Standard Booking
    # SHOP Phase
    ...
    Examples:
      ...
      | USA     | Dallas   | Holiday   | 20 Miles | 90   | 1      | 1     | 1      | Sabre    | No         | Credit Card    | Cancel by Room | Booker,Agent,Client |
