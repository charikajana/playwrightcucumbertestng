...
Feature: Sabre vs Sabre Refundable Booking Flow Validation
  ...
  Scenario Outline: Sabre vs Sabre Multi Night Single Room Single Guest Standard Booking
    ...
    Examples:
      ...
      | USA     | Dallas   | Holiday   | 20 Miles | 90   | 1      | 1     | 1      | Sabre    | Yes         | Credit Card    | Cancel by Room | Booker,Agent,Client |
