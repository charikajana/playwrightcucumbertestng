...
Feature: Sabre vs Sabre Same Day Booking Single Room Single Guest Booking
  ...
  Scenario Outline: Sabre vs Sabre Multi Night Single Room Single Guest Standard Booking
    ...
    Examples:
      ...
      | USA     | Dallas   | Holiday   | 20 Miles | 30   | 1      | 1     | 1      | Sabre    | yes         | Credit Card    | Cancel by Room | Booker,Agent,Client |
