@Sabre_vs_Sabre_Sanity @Sanity @MultiGuest @TestOne
Feature: Sabre vs Sabre Single Night Single Room Multi Guest Booking
  ...
  Scenario Outline: Sabre vs Sabre Single Night Single Room Multi Guest Standard Booking
    # SHOP Phase
    ...
    Examples:
      ...
      | USA     | Dallas   | Holiday   | 20 Miles | 30   | 1      | 1     | 2      | Sabre    | No         | Credit Card    | Cancel by Room | Booker,Agent,Client |
